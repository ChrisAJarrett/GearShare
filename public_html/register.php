...
<html>
    ...
    <body>
        ...
        <form class="form-horizontal" action="accountProcess.php" method="post">
                ...
                <div class="container-fluid" style="padding-top: 2vw">
                    ...
                    <div class="row" style="padding-top:1vw">
                        <div class="col-xs-offset-2 col-xs-7 col-md-offset-5 col-md-2">
                            ...
                            <input class="form-control" type="text" name="password2" id="password2" size="30">
                        </div>
                    </div>
                    ...
                    <div class="row" style="padding-top:1vw">
                        <div class="col-xs-offset-2 col-xs-7 col-md-offset-5 col-md-2">
                            ...
                            <input class="form-control" type="text" name="fname" id="fname" size="30">
                        </div>
                    </div>
                    ...
                    <div class="row" style="padding-top:1vw">
                        <div class="col-xs-offset-2 col-xs-7 col-md-offset-5 col-md-2">
                            ...
                            <input class="form-control" type="text" name="lname" id="lname" size="30">
                        </div>
                    </div>
